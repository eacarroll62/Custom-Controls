...
struct SegmentedPicker: View {
    private static let ActiveSegmentColor: Color = Color.lemon
    private static let BackgroundColor: Color = Color.mediumPurple
    private static let ShadowColor: Color = Color.black.opacity(0.2)
    private static let TextColor: Color = Color.lemonChiffon
    private static let SelectedTextColor: Color = Color.red
    ...
    private var activeSegmentView: AnyView {
        ...
        return
            RoundedRectangle(cornerRadius: SegmentedPicker.SegmentCornerRadius)
                ...
                .animation(Animation.linear(duration: SegmentedPicker.AnimationDuration), value: 0.1)
                .eraseToAnyView()
    }
...
struct SegmentedPicker_Previews: PreviewProvider {
    static let items: [String] = ["M", "T", "W", "T", "F"]
    
    static var previews: some View {
        SegmentedPicker(items: items, selection: .constant(2))
    }
}
